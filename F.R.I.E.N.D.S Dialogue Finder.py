...
When the user enters a dialouge or even a PART of a dialouge, it will first check if all the episodes are present and then ask the user to enter the dialouge. If the dialouge is present, it will show the episode title and the season number and episode number.
